...
const AdminSidebar = () => {
  ...
  return (
    ...
    <div className="mt-6">
      <button className='py-2 px-4 bg-red-500 hover:bg-red-600 text-lg text-white w-full rounded flex items-center justify-center space-x-2' onClick={handleLogout}>
        <FaSignOutAlt/>
        <span>Logout</span>
      </button>
    </div>
